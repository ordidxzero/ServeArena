...
server_cmd = CommandTemplate("vllm serve meta-llama/Llama-3.1-8B-Instruct --dtype bfloat16")
...
runner = VLLMRunner(benchmark_cmd=benchmark_cmd, server_cmd=server_cmd, envs={"VLLM_USE_V1": "1", "CUDA_VISIBLE_DEVICES": "3", 'VLLM_LOG_STATS_INTERVAL': '0.02'}, logger=logger)
